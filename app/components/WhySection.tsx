...
export default function WhySection() {
    return (
        <div className="flex flex-col items-center justify-center px-6 md:px-20 py-20 bg-gray-50 gap-5">
            ...
            <div>
                <Link href="/features">
                    <button className="group px-8 py-2.5 bg-green-400 rounded-lg text-white cursor-pointer active:scale-95 transition duration-300 hover:bg-green-500">
