...
export default function ContactPage() {
  return (
    <div className="min-h-screen  flex items-center justify-center p-6 float">
      <div className="max-w-6xl w-full  rounded-3xl shadow-xl grid grid-cols-1 md:grid-cols-2 overflow-hidden animate-[gentleFloat_4s_ease-in-out_infinite]">
        {/*Form left side*/}
        <div className="p-10">
          ...
          <div className="space-y-4 bg-white p-6 rounded-2xl shadow">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">+94 708324923</p>
              </div>
            </div>
          </div>
        </div>
